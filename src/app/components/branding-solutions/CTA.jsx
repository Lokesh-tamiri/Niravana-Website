      ...
      <div className="container">
        <div className="row justify-center mx-0">
          <GsapAnimation
            ...
            className="text-center rounded-[60px] bg-gradient-to-br from-[#FF5722] to-[#261362] py-[80px] px-[50px] opacity-0 lg:px-[30px] sm:py-[50px] sm:px-[25px]"
          >
            <div className="relative">
              ...
              <h2 className="heading-3 font-poppins text-white font-semibold mb-[15px]">
                Let&apos;s craft a brand that resonates
              </h2>

              <p className="mb-[35px] text-white/80 max-w-2xl mx-auto">
                Ready to elevate your brand identity? Our experienced team will
                help you create a cohesive visual language that connects with
                your audience.
              </p>
