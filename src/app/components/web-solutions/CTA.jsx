      ...
      <div className="container">
        <div className="row justify-center mx-0">
          <GsapAnimation
            ...
            className="text-center rounded-[60px] bg-gradient-to-br from-[#3366FF] to-[#261362] py-[80px] px-[50px] opacity-0 lg:px-[30px] sm:py-[50px] sm:px-[25px]"
          >
            <div className="relative">
              ...
              <p className="mb-[35px] text-white/80 max-w-2xl mx-auto">
                Ready to transform your digital presence with scalable web
                solutions? Our team is here to bring your vision to life.
              </p>
