        ...
        <div className="row items-center">
          ...
          <div className="col text-center">
            ...
            <a
              ...
              className="heading-6 font-poppins"
            >
              {process.env.NEXT_PUBLIC_MAIL_ID || "operations@niravana.in"}
            </a>
          </div>
      ...
      <div className="container">
        <div className="row justify-between gap-y-10">
          <div className="col-lg-3 col-md-6">
            <Logo
              className="mb-[40px] inline-block sm:mb-[20px]"
              width={70}
              height={70}
            />
          ...
          <div className="col-lg-2 col-md-6 offset-xl-2">
            <h3 className="heading-6 text-white font-semibold mb-[30px] sm:mb-[15px]">
              Pages
            </h3>
            <ul>
              <li>
              ...
              <li>
                <Link
                  href="/contact"
                  className={`font-medium hover:text-white leading-[30px] transition-all${
                    pathname === "/contact" ? " active text-white" : ""
                  }`}
                >
                  Contact
                </Link>
            ...
            <ul>
              <li className="flex gap-x-[15px] mb-[10px]">
                ...
                <a
                  ...
                  href="tel:+91917993598294row justify-between gap-y-10"
                >
                  +91 7993598294
                </a>
              </li>
