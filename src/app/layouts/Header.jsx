...
const Header = () => {
  ...
  useEffect(() => {
    ...
    const prefetchRoutes = ["/", "/about", "/contact", "/web-innovations", "/ai-innovations", "/mobile-innovations"]
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div 
                  ...
                  style={{
                    opacity: 1,
                    animation: `contentFadeOut ${animationDuration * 0.5}ms ease-in forwards`
                  }}
                >
            ...
            >
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div 
                  ...
                  style={{
                    opacity: 0,
                    animation: `contentFadeIn ${animationDuration * 0.5}ms ease-out ${animationDuration * 0.5}ms forwards`
                  }}
                >
                  {transitionPage || ''}
                </div>
                ...
                <div 
                  ...
                  style={{
                    background: 'linear-gradient(315deg, transparent 50%, rgba(255,255,255,0.1) 50%)',
            ...
            >
              ...
              >
                ...
                <div 
                  className="absolute inset-0"
                  style={{
                    background: 'linear-gradient(to right, rgba(0,0,0,0.1), rgba(255,255,255,0.1) 15%, rgba(255,255,255,0.15) 35%, rgba(255,255,255,0.05) 50%, rgba(0,0,0,0.15) 85%, rgba(0,0,0,0.4) 100%)'
                  }}
                />
                ...
                {/* Edge shadow */}
                <div 
                  className="absolute right-0 top-0 h-full w-[1px] bg-black opacity-40"
                />
              </div>
              ...
              >
                ...
                <div 
                  className="absolute inset-0"
                  style={{
                    background: 'linear-gradient(to left, rgba(0,0,0,0.1), rgba(255,255,255,0.1) 15%, rgba(255,255,255,0.15) 35%, rgba(255,255,255,0.05) 50%, rgba(0,0,0,0.15) 85%, rgba(0,0,0,0.4) 100%)'
                  }}
                />
                ...
                {/* Edge shadow */}
                <div 
                  className="absolute left-0 top-0 h-full w-[1px] bg-black opacity-40"
                />
              </div>
            </div>
          </div>
          ...
          <nav ref={headerNav} className="flex justify-between items-center transition-all ease-in-out duration-[500ms]">
            ...
            <ul
              className={`flex gap-x-6 sm:absolute sm:top-[115%] sm:left-[15px] sm:bg-darkgray sm:p-[25px] sm:w-[calc(100%-30px)] sm:rounded-[15px] sm:flex-col sm:gap-y-4 transition-all duration-500 ${
                toggle ? "sm:[clip-path:polygon(0_0,100%_0,100%_100%,0_100%)]" : "sm:[clip-path:polygon(0_0,100%_0,100%_0,0_0)]"
              }`}
            >
              <li>
                <Link 
                  ...
                  className={`font-medium ${pathname === "/" ? "text-white" : ""} relative before:absolute before:bottom-0 before:left-0 before:w-0 before:h-[2px] before:bg-white hover:before:w-full before:transition-all before:duration-300`}
                >
                  Home
                </Link>
              </li>
              <li>
                <Link 
                  ...
                  className={`font-medium ${pathname === "/about" ? "text-white" : ""} relative before:absolute before:bottom-0 before:left-0 before:w-0 before:h-[2px] before:bg-white hover:before:w-full before:transition-all before:duration-300`}
                >
                  About
                </Link>
              </li>
              <li className="relative z-50">
                <button
                  ...
                  className={`font-medium flex items-center gap-1 ${pathname.startsWith("/work") ? "text-white" : ""} relative before:absolute before:bottom-0 before:left-0 before:w-0 before:h-[2px] before:bg-white hover:before:w-full before:transition-all before:duration-300`}
                >
                  Work <span className={`ml-1 transition-transform duration-300 ${workDropdownOpen ? "rotate-180" : ""}`}>▾</span>
                </button>
                ...
                <div className="absolute left-0 top-full mt-2 w-56 z-50">
                  <ul
                    className={`bg-[#1a1a1a] text-white rounded-lg shadow-xl overflow-hidden transition-all duration-300 ease-in-out ${
                      workDropdownOpen ? "max-h-60 opacity-100" : "max-h-0 opacity-0"
                    }`}
                  >
                    <li>
                      <Link
                        ...
                        onClick={(e) => handleNavigation(e, "/web-innovations", "Web")}
                      >
                        Web Innovations
                      </Link>
                    </li>
                    <li>
                      <Link
                        href="/ai-innovations"
                        className="block px-4 py-2 hover:bg-gray-700 hover:pl-6 transition-all duration-300"
                        onClick={(e) => handleNavigation(e, "/ai-innovations", "AI")}
                      >
                        AI Innovations
                      </Link>
                    </li>
                    <li>
                      <Link
                        ...
                        className="block px-4 py-2 hover:bg-gray-700 hover:pl-6 transition-all duration-300"
                        onClick={(e) => handleNavigation(e, "/mobile-innovations", "Mobile")}
                      >
                        Mobile Innovations
                      </Link>
                    </li>
              ...
              <li>
                <Link 
                  ...
                  className={`font-medium ${pathname === "/contact" ? "text-white" : ""} relative before:absolute before:bottom-0 before:left-0 before:w-0 before:h-[2px] before:bg-white hover:before:w-full before:transition-all before:duration-300`}
                >
                  Contact
                </Link>
              </li>
