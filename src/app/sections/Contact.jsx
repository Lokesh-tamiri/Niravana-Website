      ...
      <div className="container relative">
        <div className="row justify-between gap-y-20">
          <div className="col-lg-6">
            <h1 className="text-white w-[80%] font-semibold mb-[100px] xl:mb-[50px]">
              Get in touch.
            </h1>
            <div className="contact-box bg-[linear-gradient(135deg,rgba(216,216,216,0.2),transparent)] rounded-[35px] px-[55px] py-[70px] backdrop-blur-2xl backdrop-saturate-100 xl:px-[45px] xl:py-[60px] lg:py-[40px] lg:px-[30px]">
              <h2 className="heading-4 text-white font-semibold mb-[55px] xl:mb-[30px]">
              ...
              <form className="row" onSubmit={handleSubmit}>
                ...
                <FloatingInput
                  label="Email *"
                  type="email"
                  className={`floating-label col-sm-6 mb-[25px] ${
                    errors.email && "error"
                  }`}
                  name="email"
                  value={email}
          ...
          <div className="col-auto">
            <div className="flex items-start mb-[90px]">
              ...
              />
              <div>
                <h3 className="heading-4 text-white font-semibold mb-[10px]">
                  Phone
                </h3>
                <a href="tel:+917993598294" className="heading-6">
                  +91 7993598294
                </a>
              </div>
            </div>
            <div className="flex items-start mb-[90px]">
              ...
              <div>
                ...
                <a
                  href={`mailto:${
                    process.env.NEXT_PUBLIC_MAIL_ID || "operations@niravana.in"
                  }`}
                  className="heading-6"
                >
                  {process.env.NEXT_PUBLIC_MAIL_ID || "operations@niravana.in"}
                  ...
                  <li>
                    <a
                      href={
                        ...
                        "https://www.instagram.com/niravana.in"
                      }
                      target="_blank"
